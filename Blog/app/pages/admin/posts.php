<?php if($action == 'add'):?>
    <div class="col-md-6 mx-auto">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="my-2">
                Featured Image:<br>
                <label for="image" class="w-100 my-2">
                    <img src="<?=get_image('')?>" alt="" class="mx-auto d-block image-preview-edit" style="width: 150px; height: 150px; object-fit: cover; cursor: pointer">
