    ...
    <body>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <img src="<?=ROOT?>/assets/images/slider_1.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="<?=ROOT?>/assets/images/slider_2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="<?=ROOT?>/assets/images/slider_3.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="row g-0 border rounded overflow-hidden flex-column flex-lg-row mb-4 shadow-sm h-md-250 position-relative">
                        ...
                        <div class="col-auto d-lg-block">
                            ...
                            <img src="<?=ROOT?>/assets/images/card_1.jpeg" class="bd-placeholder-img w-100" width="200" height="250" alt="">
                        </div>
                    </div>
                </div>
                <!-- card 2 -->
                <div class="col-md-6">
                    <div class="row g-0 border rounded overflow-hidden flex-column flex-lg-row mb-4 shadow-sm h-md-250 position-relative">
                        ...
                        <div class="col-auto d-lg-block">
                            ...
                            <img src="<?=ROOT?>/assets/images/card_2.avif" class="bd-placeholder-img w-100" width="200" height="250" alt="">
